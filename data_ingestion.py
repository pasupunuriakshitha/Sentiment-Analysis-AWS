...
def load_imdb_data(sample_size=None):
    ...
    # Load Dataset
    logger.info("Data Ingestion begining...")
    ...
    logger.info(f"These are train and test df's {train_df.shape}, {test_df.shape}")
    ...
    if sample_size:
        ...
        test_df = test_df.sample(n=min(sample_size, len(train_df)), random_state=42)

    return train_df, test_df

if __name__ == "__main__":
    load_imdb_data(sample_size=1000)
