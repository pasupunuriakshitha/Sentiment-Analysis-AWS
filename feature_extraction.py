...
class FeatureExtractor:
    ...
    def transform(self, documents):
        ...
        if self.vectorizer is None:
            raise ValueError("vectorizer not fitted yet, call the fit_transform intitally")
...
if __name__ == "__main__":
    sample_docs = [
        ...
        "the protagonist was very engaging and the plot was thrilling",
    ]
    ...
    tfidf = FeatureExtractor(method='tfidf', max_features=1000)
